...
(function ($) {
    ...
    $(document).ready(function () {
        $('.open-carousel-popup').magnificPopup({
            ...
            callbacks: {
                open: function () {
                    var $carousel = $(this.content).find('.owl-carousel');

                    // Properly destroy the existing carousel if it exists
                    if ($carousel.hasClass('owl-loaded')) {
                        ...
                        // Keep only original .item elements
                        let items = '';
                        $carousel.find('.item').each(function () {
                            items += $(this).prop('outerHTML');
                        });
                        $carousel.html(items);
                    }
                ...
                close: function () {
                    ...
                    if
                        ...
                        try {
                            ...
                            console.log('Error destroying carousel, safely handled:', e);
                        }
                    } else {
                        console.log('No carousel instance found to destroy on close');
                    }
                    // Clean up residual elements
